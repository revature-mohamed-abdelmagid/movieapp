...
const MovieInfo = ({ movie }) => {
      ...
      <div className=" main-content flex min-h-screen flex-col items-start justify-center p-4 md:flex-row md:p-8 lg:p-12  ">
        ...
        >
          ...
          <div className="flex flex-row gap-6 items-center">
             {movie.releaseYear}  <span>  • </span> <div> <span className="inline-block flex flex-row justify-center text-yellow-300 text-md "> <FaStar /></span> {movie.avgRating} </div>  <span> • </span> {formatDuration(movie.duration)}
  ...
  <img src={actor.profileUrl} alt={actor.name} className="w-full h-auto" />
